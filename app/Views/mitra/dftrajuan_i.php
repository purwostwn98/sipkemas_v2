...
<div id="accordion" class="card shadow mb-4">
    <div class="card-header py-3">
        <div>
            <a class="btn btn-sm btn-secondary" data-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample5">
                Dalam Proses
            </a>
    ...
    <div class="collapse show" id="collapseExample5" data-parent="#accordion">
        <div style="font-size: 12px;" class="card-body">
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable" id="dataTable3" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                <thead>
                                    <tr class="text-center" role="row">
                                        <th class="sorting_asc" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending" style="width: 10px;">No</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending" style="width: 30px;">No.Ajuan</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-sort="ascending" aria-label="No: activate to sort column descending" style="width: 45px;">NIK</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-label="Nama: activate to sort column ascending" style="width: 62px;">Nama</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-label="Tgl. Ajuan: activate to sort column ascending" style="width: 40px;">Tgl. Ajuan</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-label="Jenis Bantuan: activate to sort column ascending" style="width: 30px;">Program Bantuan</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 55px;">Rek.Kesra</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" aria-label="Status Ajuan: activate to sort column ascending" style="width: 30px;">Status Ajuan</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($ajuan_otw as $otw) : ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td><?= $otw['Nama']; ?></td>
                                            <?php
                                            $blnthn = explode('-', $otw['tgAjuan']);
                                            ?>
                                            <td><?= $blnthn[2] . ' ' . $bulan[(int)$blnthn[1]] . ' ' . $blnthn[0]; ?></td>
                                            <td><?= $otw['NamaMitra']; ?>: <?= $otw['namaProgram']; ?></td>
                                            <td class="text-center">
                                                <span class="fa fa-star <?= ($otw['idRecKesra'] >= 1) ? 'oke' : '' ?>"></span>
                                                <span class="fa fa-star <?= ($otw['idRecKesra'] >= 2) ? 'oke' : '' ?>"></span>
                                                <span class="fa fa-star <?= ($otw['idRecKesra'] >= 3) ? 'oke' : '' ?>"></span>
                                                <span class="fa fa-star <?= ($otw['idRecKesra'] >= 4) ? 'oke' : '' ?>"></span>
                                                <span class="fa fa-star <?= ($otw['idRecKesra'] == 5) ? 'oke' : '' ?>"></span>
                                            </td>
                                            <td>
                                                <span style="border-radius: 5px;" <?php if ($otw['idStsAjuan'] == 1) {
                                                                                        echo ("class='small text-white bg-gray-600 p-1'");
                                                                                    } elseif ($otw['idStsAjuan'] == 2) {
                                                                                        echo ("class='small text-white bg-info p-1'");
                                                                                    } elseif ($otw['idStsAjuan'] == 3) {
                                                                                        echo ("class='small text-white bg-warning p-1'");
                                                                                    } elseif ($otw['idStsAjuan'] == 4) {
                                                                                        echo ("class='small text-white bg-primary p-1'");
                                                                                    } elseif ($otw['idStsAjuan'] == 5) {
                                                                                        echo ("class='small text-white bg-primary p-1'");
                                                                                    } ?>>
                                                    <?= $otw['StatusAjuan']; ?>
                                                </span>
